...
write_hdl basic_top -language v2001 > syn_basic_top.v
write_sdf -edges check_edge -design basic_top > basic_top.sdf

#add timescale directive
file rename syn_basic_top.v syn_orig.v
set fin [open syn_orig.v r]
set fout [open syn_basic_top.v w]
